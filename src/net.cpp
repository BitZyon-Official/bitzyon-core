...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitZyon " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.bitzyon.com", "seed1.bitzyon.com"},
    {"seed2.bitzyon.com", "seed2.bitzyon.com"},
    {"seed3.bitzyon.com", "seed3.bitzyon.com"},
    {"seed4.bitzyon.com", "seed4.bitzyon.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("BitZyon-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitZyon is probably already running."), addrBind.ToString().c_str());
        else
