...
namespace Checkpoints
{
    ...
    // BitZyon: synchronized checkpoint (centrally broadcasted)
    ...
    // BitZyon: get last synchronized checkpoint
    ...
    // BitZyon: only descendant of current sync-checkpoint is allowed
    ...
    // BitZyon: reset synchronized checkpoint to last hardened checkpoint
...
// BitZyon: sync-checkpoint master key
...
// BitZyon: verify signature of sync-checkpoint message
...
// BitZyon: process synchronized checkpoint
