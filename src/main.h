...
static const uint256 hashGenesisBlock("0x00000aa38cf5d98ed8965924deeb4a5b83e164dde8095e07aaba261991dd9941");
...
public:
    ...
    {
        // BitZyon: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // BitZyon: get transaction coin age
...
public:
    ...
    // BitZyon: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // BitZyon: two types of block: proof-of-work or proof-of-stake
    ...
    // BitZyon: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // BitZyon: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // BitZyon: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // BitZyon: block index flags
    enum
    {
